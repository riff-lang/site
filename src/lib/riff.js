...
CodeMirror.defineSimpleMode("riff", {
    start: [
        ...
        // Floats
        { regex: /\d[\d_]*\.(?!\.)/g, token: 'number', next: 'infix' },
        { regex: /0[xX][A-Fa-f0-9_]*\.(?!\.)/, token: 'number', next: 'infix' },
        ...
        // ..
        // Make sure this plays nicely with floats without a leading/trailing
        // integer
        ...
        { regex: /(and|not|or)\b/, token: 'keyword' },
    ...
    infix: [
        { regex: /\.{2}/, token: 'operator', next: 'start' },
        { regex: /\s/, next: 'infix' },
        { regex: /\/\/.*$/, token: 'comment' },
        { regex: /\/\*/, token: 'comment', push: 'comment' },
        { regex: /;/, next: 'start' },
    ...
    string: [
        ...
        // TODO defer to 'start' for brace-delimited expressions
