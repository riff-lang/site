...
CodeMirror.defineSimpleMode("riff", {
    start: [
        ...
        // Floats
        { regex: /\b0[xX][A-Fa-f0-9_]*\.?[A-Fa-f0-9][A-Fa-f0-9_]*([pP][+-]?[A-Fa-f0-9][A-Fa-f0-9_]*)?/, token: 'number' },
        { regex: /\b0[xX][A-Fa-f0-9_]*([pP][+-]?[A-Fa-f0-9][A-Fa-f0-9_]*)?/, token: 'number' },
        ...
        { regex: /(byte|char|fmt|hex|lower|num|split|upper)\b/, token: 'builtin' },
